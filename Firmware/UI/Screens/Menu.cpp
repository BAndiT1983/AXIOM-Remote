...
Menu::Menu(IUSBDevice* cdcDevice, CentralDB* centralDB) :
    ...
    _parameterListScreen(cdcDevice), _numericValueScreen(cdcDevice), _db(centralDB), _selectionButtonBeingPressed(false)
{
    // UNUSED(cdcDevice);
...
void Menu::SetLabel(const char* value)
{
    _label = value;
}
...
void Menu::Update(Button button, int8_t knob, IMenuSystem* menuSystem)
{
